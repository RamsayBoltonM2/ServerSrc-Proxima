...
class CClientManager : public CNetBase, public singleton<CClientManager>
{
	...
	void		ChequeLog(TPacketChequeLog* p);
#endif
	 ...
	 */
	void		MyshopPricelistUpdate(const TItemPriceListTable* pPacket); // @fixme (TPacketMyshopPricelistHeader to TItemPriceListTable)
