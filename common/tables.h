...
enum
{
	...
	HEADER_GD_UPDATE_OFFLINESHOP_COUNT			= 141,
#endif
#ifdef WJ_DUNGEON_FOR_GUILD
	HEADER_GD_GUILD_DUNGEON 					= 142,
	HEADER_GD_GUILD_DUNGEON_CD 					= 143,
#endif
...
#ifdef WJ_CHEQUE_SYSTEM
typedef struct SPacketChequeLog
{
	BYTE type;
	DWORD vnum;
	INT cheque;
