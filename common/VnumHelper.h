...
public:
	...
	static	const bool	IsDeadlyPowerRing(DWORD vnum)	{ return 71148 == vnum; }
	static	const bool	IsWillPowerRing(DWORD vnum)	{ return 71149 == vnum; }
	static	const bool	IsMedalOfHeroism(DWORD vnum) { return 71158 == vnum; }
	static	const bool	IsMagicCandy(DWORD vnum) { return 71188 == vnum; }
	static	const bool	IsChocolateCharm(DWORD vnum) { return 71199 == vnum; }
	static	const bool	IsEvilEyeCharm(DWORD vnum) { return 71202 == vnum; }
	
#ifdef WJ_ACCE_SYSTEM
	static const bool IsAcceItem(DWORD type, DWORD subType) {
		if (type == 28 && subType == 2)
			return true;
		return false;
	}
#endif
