...
enum EMisc
{
	...
	OFFLINE_SHOP_MAX_COUNT			= 500,	// Channel
	OFFLINE_SHOP_SAVE_TIME			= 5,	// Minitue
	OFFLINE_SHOP_DEFAULT_TIME		= 21600,
	...
	/* National Point */
	NATIONAL_POINT_MAX				= 10000,
	NATIONAL_POINT_WAIT_TIME		= 120,
	/* National Point */
#endif
...
typedef struct SItemPos
{
	...
	bool IsValidItemPosition() const
	{
		...
		// ?i??????·I ?쭵±a°?� A?퀰?Ao??A window??A valid ???쭵??| C? ?o°?� ?????.
		case SAFEBOX:
		case MALL:
			return false;
		default:
