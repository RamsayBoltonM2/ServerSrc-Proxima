...
class CHARACTER_MANAGER : public singleton<CHARACTER_MANAGER>
{
	public:
		...
		LPCHARACTER		SpawnMob(DWORD dwVnum, long lMapIndex, long x, long y, long z, bool bSpawnMotion = false, int iRot = -1, bool bShow = true, bool bAggressive = false, bool isOfflineShopNPC = false, DWORD real_owner = 0);
#else
