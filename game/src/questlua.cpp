...
namespace quest
{
	...
	bool CQuestManager::InitializeLua()
	{
		...
		// LUA_INIT_ERROR_MESSAGE
		{
			...
			snprintf(settingsFileName, sizeof(settingsFileName), "%s/quest/system/settings.lua", LocaleService_GetBasePath().c_str());
...

		{
			...
			snprintf(questlibFileName, sizeof(questlibFileName), "%s/system/questlib.lua", LocaleService_GetQuestPath().c_str());
...

		{
			...
			snprintf(translateFileName, sizeof(translateFileName), "%s/quest/system/translate.lua", LocaleService_GetBasePath().c_str());
...

		{
			...
			snprintf(questLocaleFileName, sizeof(questLocaleFileName), "%s/system/locale.lua", g_stQuestDir.c_str());
