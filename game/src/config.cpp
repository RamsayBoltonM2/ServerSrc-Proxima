...
// for new functions
int g_iItemStackCount = 200;
int g_iItemOwnershipTime = 300;
...
bool	g_bBeltAllowItems = false;
bool	g_bPackageEnable = false;
//////////////////////////////
int		g_iStatusPointGetLevelLimit = gPlayerMaxLevel;
	...
	while (fgets(buf, 256, fp))
	{
		...
		TOKEN("disable_shop_price_3x")
		{
			...
			if (1 == flag)
				...
				g_bEmpireShopPriceTripleDisable = false;
		...
		TOKEN("disable_change_attr_time")
		{
			...
			if (1 == flag)
				...
				g_bDisableItemBonusChangeTime = false;
		...
		TOKEN("belt_allow_all_items")
		{
			...
			if (1 == flag)
				g_bBeltAllowItems = true;
			else
				g_bBeltAllowItems = false;
		...
		TOKEN("package_enable")
		{
			...
			if (1 == flag)
				g_bPackageEnable = true;
			else
				g_bPackageEnable = false;
