...
class LogManager : public singleton<LogManager>
{
	public:
		...
		void		ChequeLog(BYTE type, DWORD vnum, int cheque);
#endif
	...
	#ifdef WJ_CHEQUE_SYSTEM
		DWORD		ExchangeLog(int type, DWORD dwPID1, DWORD dwPID2, long x, long y, int goldA = 0, int goldB = 0, int chequeA = 0, int chequeB = 0);
	#else
		DWORD		ExchangeLog(int type, DWORD dwPID1, DWORD dwPID2, long x, long y, int goldA = 0, int goldB = 0);
	#endif
