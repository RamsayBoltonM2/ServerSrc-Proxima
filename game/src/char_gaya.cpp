...
const char* txt_gaya[] = {
	LC_TEXT("[Gaya] Yeterli gaya yok."),
	LC_TEXT("[Gaya] Hata."),
	LC_TEXT("[Gaya] %d adet %s gerekli."),
	LC_TEXT("[Gaya] Yeterli yang yok."),
	LC_TEXT("[Gaya] Gaya miktari: %d."),
	LC_TEXT("[Gaya] Bileme islemi basarili oldu."),
	LC_TEXT("[Gaya] Bileme islemi basarisiz oldu.")
};
