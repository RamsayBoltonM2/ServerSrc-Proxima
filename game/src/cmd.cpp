...
struct command_info cmd_info[] =
{
	...
	{ "shutdown",	do_shutdown,		0,			POS_DEAD,	GM_IMPLEMENTOR	}, // @fixme44 GM_HIGH_WIZARD -> GM_IMPLEMENTOR
...
//	{ "로그를보여줘",	do_detaillog,		0,			POS_DEAD,	GM_LOW_WIZARD	},//@fixme19
//	{ "몬스터보여줘",	do_monsterlog,		0,			POS_DEAD,	GM_LOW_WIZARD	},//@fixme19
