...
namespace MeleyLair
{
	...
	class CMgrMap
	{
		public:
			...
			void	EndDungeon(bool bSuccess, bool bGiveBack, bool bDestroy = false);
			void	EndDungeonWarp();
			...
			bool	IsAlreadyStart() { return m_bStart; }
			void	PrepareStart();
			void	PrepareDestroy();
	...
	class CMgr : public singleton<CMgr>
	{
		public:
			...
			bool	IsAlreadyStart(LPCHARACTER pkChar, CGuild* pkGuild);
			void	End(LPCHARACTER pkChar, CGuild* pkGuild);
