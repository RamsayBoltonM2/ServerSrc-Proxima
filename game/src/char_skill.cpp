...
#if defined(WJ_WOLFMAN_CHARACTER) && defined(USE_RESIST_CLAW_AS_DAGGER)
							case WEAPON_CLAW:
								iDam = iDam * (100 - pkChrVictim->GetPoint(POINT_RESIST_DAGGER)) / 100;
								break;
#endif
...
bool CHARACTER::UseSkill(DWORD dwVnum, LPCHARACTER pkVictim, bool bUseGrandMaster)
{
	...
	if (GetMapIndex() == 113)
	{
		ChatPacket(CHAT_TYPE_NOTICE, LC_TEXT("OXEVENT_SKILL_BLOCK"));	
		return false;
	}
...
int __MountAtkSkill(DWORD dwMountVnum, bool IsNew)
{
	...
	switch (dwMountVnum)
	{
		...
		/// Yeni Eklenenler ///
		case 20235:	// Cesur_Hindi Seviye-3
		case 20236:	// Mufffin_Kahve
		case 20237:	// Muffin_Mavi
		case 20238:	// Muffin_Yesil
		case 20239:	// Nugget_Kahve
		case 20240:	// Nugget_Mavi
		case 20241:	// Nugget_Yesil
		/// Yeni Eklenenler ///
		...
		/// Yeni Eklenenler ///
		case 20234:	// Vahsi_Hindi Seviye-2
		/// Yeni Eklenenler ///
		...
		/// Yeni Eklenenler ///
		case 20233:	// Genc_Hindi Seviye-1
		/// Yeni Eklenenler ///
